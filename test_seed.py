...
# def test_data():
    ...
    # model.BookCategory.query.delete()
    # model.Event.query.delete()
    # model.EventBook.query.delete()
    # model.EventAttendee.query.delete()
    # model.Friendship.query.delete()
    
#create books for testing
harry_potter = crud.create_book("oxxszQEACAAJ", "Harry Potter and the Half-Blood Prince", 
...
bees = crud.create_book("FiIXot_e10sC", "The Secret Life of Bees", "Sue Monk Kidd",
...
hidden = crud.create_book("bxahDwAAQBAJ", "Hidden Valley Road", "Robert Kolker", 
...
crawdads = crud.create_book("CGVDDwAAQBAJ", "Where the Crawdads Sing", 
...
wind = crud.create_book("BcG2dVRXKukC", "The Name of the Wind", "Patrick Rothfuss",
...
addie = crud.create_book("vH3LDwAAQBAJ", "The Invisible Life of Addie LaRue",
...
mistborn = crud.create_book("t_ZYYXZq4RgC", "Mistborn", "Brandon Sanderson",
...
kings = crud.create_book("QVn-CgAAQBAJ", "The Way of Kings", "Brandon Sanderson",
...
evelyn = crud.create_book("PxNcDwAAQBAJ", "The 7 1⁄2 Deaths of Evelyn Hardcastle",
...
haley = crud.create_user("Haley", "Laine", "haley@test.com", "test")
connor = crud.create_user("Connor", "Laine", "connor@test.com", "test")
steven = crud.create_user("Steven", "Laine", "steven@test.com", "test")
mary = crud.create_user("Mary", "Laine", "mary@test.com", "test")
jake = crud.create_user("Jake", "Laine", "Jake@test.com", "test")
