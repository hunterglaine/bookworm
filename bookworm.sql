...
SELECT pg_catalog.setval('public.books_categories_id_seq', 88, true);
...
SELECT pg_catalog.setval('public.events_attendees_id_seq', 26, true);
...
SELECT pg_catalog.setval('public.events_books_id_seq', 20, true);
